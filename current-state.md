...
| **Jul 25, 2026** | **Burning River 100 — Leg 8 (final/anchor leg)** | **12.3 mi (+1,144 ft elev)** | **38% paved / 59% unpaved / 3% unknown** | **Trail run (relay).** Forcing function for run volume, NOT an A race. Filling in for injured runner; goal is "finish strong, give the team the line." Front half rolling, big climb mile 7-8, back half rolling high. **NIGHT RUN — Leg 8 est. 2:15 AM but HIGHLY uncertain (realistic range 11 PM–4 AM)** — 7 runners / 88 mi ahead of him, estimate errors compound; won't have a real read until ~5 legs done (Sat evening). Plan must be **adaptive, keyed to tracking the team's actual splits**, not a fixed clock. **Cooler/dark = advantage** (heat's been the summer limiter). Prep: headlamp + spare batteries, caffeine timing, pre-nap, evening/wait fueling plan. **Race HR plan (Roger's): 1st third <145, middle <148 (big climb here — let it spike, settle after), last third let it rip.** Fuel: Sunday's 4.5 scoops/1.5L was right for 10 mi; 12.3 mi needs a bit more fluid (cool night offsets sweat). **Right-size the taper — this is a 12.3 mi relay leg, not a 50-miler; don't over-engineer.** |
